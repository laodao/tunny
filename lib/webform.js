...
WebForm.prototype.getController = function(){return this.controller;};
...
//WebForm.prototype.getViewPath = function(){return path.join(config.templatePath, this.controller.getPath(), this.controller.getActionName(), config.templateSuffix[config.templateType]);};
