 ...
 */
var path = require('path'),config = require(path.resolve('.')+'/conf/config'),constant = require('./constant'),logger = require('./logger').getLogger();
...
//        if(path.existsSync(globalInterceptorPath)){
//            if (config.env == constant.devEnv) {
